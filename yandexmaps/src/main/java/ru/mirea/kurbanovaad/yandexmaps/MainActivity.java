package ru.mirea.kurbanovaad.yandexmaps;
...
import ru.mirea.kurbanovaad.yandexmaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements UserLocationObjectListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapview.getMap().move(
                new CameraPosition(new Point(55.660355609034255, 37.4777427487722), 11.0f, 0.0f, 0.0f),
